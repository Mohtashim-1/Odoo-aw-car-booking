...
class CarBooking(models.Model):
    ...
    state = fields.Selection([
        ...
        ('completed', 'Completed'),
        ('cancelled', 'Cancelled')
    ], string='Trip Status', default='draft', tracking=True, track_visibility='onchange')
    ...
    def action_view_trip_profile(self):
        ...
        if trip_profile:
            ...
            # Open form to create new trip profile with default booking_id
            return {
                'type': 'ir.actions.act_window',
                'res_model': 'trip.profile',
                'view_mode': 'form',
    ...
    def _create_trip_profile(self):
        ...
        for booking in self:
            ...
            profile_vals = {
                ...
                'city':             booking.city.id or booking.city and booking.city.id,
                ...
                'airport_id':          booking.airport_id.id,
            ...
            for line in booking.car_booking_lines:
                vehicle_lines.append((0, 0, {
                    ...
                    'type_of_service_id':   line.type_of_service_id.id,
